    ...
    <section id="hero" className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 w-full">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="reveal text-sm font-medium text-accent tracking-widest uppercase mb-4">Tersedia untuk proyek</p>
            ...
            <p className="reveal d2 text-lg md:text-xl text-zinc-400 font-light leading-relaxed max-w-md mb-10">
              {info.position}. Saya merancang dan membangun produk digital yang berkualitas — cepat, bersih, dan mudah digunakan.
            </p>
            <div className="reveal d3 flex flex-wrap gap-4">
              <a href="#work" className="shimmer inline-flex items-center gap-2 bg-white text-zinc-900 font-medium px-7 py-3.5 rounded-full hover:bg-zinc-200 transition-colors text-sm">
              ...
              <a href="#contact" className="inline-flex items-center gap-2 border border-zinc-700 text-zinc-300 font-medium px-7 py-3.5 rounded-full hover:bg-zinc-900 transition-colors text-sm">Hubungi saya</a>
            </div>
          </div>
